...
python run.py --cmd=train --device=cuda--num_layers=4 --num_heads=4 --embedding_dim=128 --batch_size=128 --epochs=25 --seq_len=10 --num_workers=10 --eval_episodes=10 --eval_before_train=False --eval_output_sequential=True --modal_embed.action_embed_class=ActionTokenizedSpreadEmbedding --modal_embed.tokenize_action=False

...
CUDA_VISIBLE_DEVICES=$DEVICE python inctxdt/run.py --cmd=downstream  --device=cuda --config_path=$CONFIG_PATH --downstream.config_path=$DOWNSTREAM_CONFIG_PATH --num_layers=$NUM_LAYERS --num_heads=$NUM_HEADS --modal_embed.per_action_encode=True --modal_embed.tokenize_action=True --modal_embed.action_embed_class=ActionTokenizedSpreadEmbedding --eval_output_sequential=False --batch_size=128 --update_steps=$UPDATE_STEPS --downstream.patch_actions=False --downstream.update_optim_actions=True --downstream.patch_states=True --downstream.update_optim_states=True --downstream.optim_only_patched=True --downstream.optim_use_default=True --log.group=$GROUP --log.job_type=UpdateAll-ActionTokenizedSpreadEmbedding --log.mode=online --seed=$SEED --train_seed=$SEED > /dev/null 2>&1 &


# spread with ALL
CUDA_VISIBLE_DEVICES=$DEVICE python inctxdt/run.py --cmd=downstream  --device=cuda --config_path=$CONFIG_PATH --downstream.config_path=$DOWNSTREAM_CONFIG_PATH --num_layers=$NUM_LAYERS --num_heads=$NUM_HEADS --modal_embed.per_action_encode=True --modal_embed.tokenize_action=True --modal_embed.action_embed_class=ActionTokenizedSpreadEmbedding --eval_output_sequential=False --batch_size=128 --update_steps=$UPDATE_STEPS --downstream.patch_actions=True --downstream.update_optim_actions=True --downstream.patch_states=True --downstream.update_optim_states=True --downstream.optim_only_patched=False --log.group=$GROUP --log.job_type=UpdateNotOnlyPatched-ActionTokenizedSpreadEmbedding  --log.mode=online --seed=$SEED --train_seed=$SEED > /dev/null 2>&1 &
...
# ActionTokenizedEmbedding - aka not spread, only patched
CUDA_VISIBLE_DEVICES=$DEVICE python inctxdt/run.py --cmd=downstream  --device=cuda --config_path=$CONFIG_PATH --downstream.config_path=$DOWNSTREAM_CONFIG_PATH --num_layers=$NUM_LAYERS --num_heads=$NUM_HEADS --modal_embed.per_action_encode=True --modal_embed.tokenize_action=True --modal_embed.action_embed_class=ActionTokenizedEmbedding --eval_output_sequential=False --batch_size=128 --update_steps=$UPDATE_STEPS --downstream.patch_actions=True --downstream.update_optim_actions=True --downstream.patch_states=True --downstream.update_optim_states=True --downstream.optim_only_patched=True --downstream.optim_use_default=True --log.group=$GROUP --log.job_type=UpdateAll-ActionTokenizedEmbedding --log.mode=online --seed=$SEED --train_seed=$SEED > /dev/null 2>&1 &
